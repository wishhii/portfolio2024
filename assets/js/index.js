...
const ImageDir = "https://hihisohi.github.io/portfolio2024/";
...
document.addEventListener("DOMContentLoaded", (event) => {
            ...
            if (lenis.animatedScroll > skills_start && lenis.animatedScroll < skills_end) {
                ...
                skills.forEach((skill, index) => {
                    ...
                    skills[skillsShuffleArray[index]].style.filter = `blur(${
                        10 -
                        ((skills_progress * (skills.length * 0.7)) / 100 - (1 / (skills.length * 0.2)) * index) * 10
                    }px)`;
                });
            }
        }
    ...
    function setImgBox(index) {
        ...
        introImgBoxs[imgBoxIndex].style.backgroundImage = `url('${ImageDir}/assets/images/intro_0${
            index + 1
        }_img.png')`;
        introImgBoxs[flatBoxIndex].style.backgroundImage = `url('${ImageDir}/assets/images/intro_0${
            index + 1
        }_flat.png')`;
        introImgBoxs[iconBoxIndex].style.backgroundImage = `url('${ImageDir}/assets/images/intro_0${
            index + 1
        }_icon.png')`;
    }
    ...
    function setRandomIcon() {
        ...
        introImgBoxs[randomIndex].style.backgroundImage = `url('${ImageDir}/assets/images/intro_0${
            randomSrc + 1
        }_icon.png')`;
    }
    ...
    function initImageBoxes() {
        ...
        addRect(cw / 2, ch / 2, size.w, size.h, {
            ...
            chamfer: { radius: 20 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_book.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 - size.w, ch / 2, size.w, size.h, {
            ...
            chamfer: { radius: 20 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_cake.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 + size.w, ch / 2, size.w, size.h, {
            label: "CLOTH",
            chamfer: { radius: 20 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_cloth.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2, ch / 2 + size.h, size.w, size.h, {
            ...
            chamfer: { radius: 20 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_clover.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 - size.w, ch / 2 + size.h, size.w, size.h, {
            ...
            chamfer: { radius: 75 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_face.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 - size.w, ch / 2 + size.h, size.w, size.h, {
            label: "LAPTOP",
            chamfer: { radius: 75 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_laptop.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 - size.w, ch / 2 + size.h, size.w, size.h, {
            label: "PENGUIN",
            chamfer: { radius: 75 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_penguin.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 - size.w, ch / 2 + size.h, size.w, size.h, {
            label: "PANTS",
            chamfer: { radius: 75 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_pants.png`, xScale: scale, yScale: scale },
            },
        });
        addRect(cw / 2 - size.w, ch / 2 + size.h, size.w, size.h, {
            label: "SOCKS",
            chamfer: { radius: 75 },
            render: {
                sprite: { texture: `${ImageDir}/assets/images/laundry_socks.png`, xScale: scale, yScale: scale },
            },
        });
    }
